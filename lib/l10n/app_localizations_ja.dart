...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get convertToStep => 'ステップに変換';
  ...
  @override
  String get sectionSchedule => 'スケジュール';

  @override
  String get sectionMeal => '食事';

  @override
  String get changeTime => '時間を変更';

  @override
  String get replaceMeal => '食事を差し替え';

  @override
  String get cardColor => 'カードの色';

  @override
  String get mealColorAuto => '自動';
  ...
  @override
  String get communityPublishInfo => 'レシピ本には公開に5件以上のレシピが必要です。レシピはスナップショットとして共有され、更新は同期されません。';
  ...
  String communityNeedMinRecipes(int count) {
    return '公開には5件以上のレシピが必要です（現在$count件）';
  }
