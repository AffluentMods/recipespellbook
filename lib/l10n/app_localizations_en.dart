...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get communityPublishBackground => 'You can browse while publishing continues in the background.';
  ...
  String communityPublishImagesSkipped(int count) {
    return '$count images were skipped';
  }

  @override
  String communityPublishRejected(int count) {
    return '$count images rejected';
  }
