...
class IngredientSuggestionService {
  ...
  static List<IngredientEntry> _buildSupplementaryIngredients() {
    const items = <(String, String, String?)>[
      ...
      // ── ALCOHOL / SPIRITS (expansion) ──
      ('Red Wine', 'Beverages', 'red wine cabernet merlot pinot noir cooking'),
      ('White Wine', 'Beverages', 'white wine chardonnay sauvignon blanc pinot grigio dry cooking'),
      ('Rosé Wine', 'Beverages', 'rose rosé wine pink'),
      ('Champagne', 'Beverages', 'champagne sparkling wine celebration brut'),
      ('Prosecco', 'Beverages', 'prosecco sparkling wine italian spritz'),
      ('Moscato', 'Beverages', 'moscato sweet white wine dessert'),
      ('Sangria', 'Beverages', 'sangria wine punch spanish'),
      ('Port Wine', 'Beverages', 'port wine fortified dessert tawny ruby'),
      ('Sherry', 'Beverages', 'sherry fortified wine dry cream amontillado'),
      ('Sweet Vermouth', 'Beverages', 'sweet vermouth rosso fortified negroni manhattan'),
      ('Beer', 'Beverages', 'beer lager ale ipa stout pilsner'),
      ('Hard Cider', 'Beverages', 'hard cider apple alcoholic'),
      ('Vodka', 'Beverages', 'vodka spirit clear'),
      ('Gin', 'Beverages', 'gin spirit juniper london dry'),
      ('White Rum', 'Beverages', 'white rum light spirit'),
      ('Dark Rum', 'Beverages', 'dark rum spirit'),
      ('Spiced Rum', 'Beverages', 'spiced rum captain'),
      ('Tequila', 'Beverages', 'tequila blanco reposado agave'),
      ('Mezcal', 'Beverages', 'mezcal smoky agave spirit'),
      ('Whiskey', 'Beverages', 'whiskey whisky rye'),
      ('Bourbon', 'Beverages', 'bourbon whiskey kentucky'),
      ('Scotch Whisky', 'Beverages', 'scotch whisky single malt'),
      ('Cognac', 'Beverages', 'cognac brandy french'),
      ('Triple Sec', 'Beverages', 'triple sec orange liqueur'),
      ('Cointreau', 'Beverages', 'cointreau orange liqueur triple sec'),
      ('Grand Marnier', 'Beverages', 'grand marnier orange liqueur cognac'),
      ('Amaretto', 'Beverages', 'amaretto almond liqueur disaronno'),
      ('Kahlúa', 'Beverages', 'kahlua coffee liqueur'),
      ('Coffee Liqueur', 'Beverages', 'coffee liqueur kahlua tia maria'),
      ('Baileys Irish Cream', 'Beverages', 'baileys irish cream liqueur'),
      ('Aperol', 'Beverages', 'aperol aperitif spritz orange'),
      ('Campari', 'Beverages', 'campari aperitif bitter negroni'),
      ('Peach Schnapps', 'Beverages', 'peach schnapps liqueur'),
      // ── BREAKFAST (expansion) ──
