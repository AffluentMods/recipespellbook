...
class IngredientSuggestionService {
  ...
  static List<IngredientEntry> _buildSupplementaryIngredients() {
    const items = <(String, String, String?)>[
      ...
      ('Worcestershire Sauce', 'Condiments', 'worcestershire sauce lea perrins'),
      ...
      // ── GRAINS & PASTA ──
      ('Quinoa', 'Grains & Pasta', 'quinoa grain'),
      ('Couscous', 'Grains & Pasta', 'couscous'),
      ...
      ('Fettuccine', 'Grains & Pasta', 'fettuccine pasta wide'),
      ...
      ('Mascarpone', 'Dairy', 'mascarpone cheese italian cream'),
