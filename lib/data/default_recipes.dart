...
const defaultRecipes = <DefaultRecipeData>[
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Beef'),
      ...
      const DefaultIngredient.header('For Serving'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Stir-Fry'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Chicken Marinade'),
      ...
      const DefaultIngredient.header('Sauce'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Bowl'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Base'),
      ...
      const DefaultIngredient.header('Toppings'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Soup Base'),
      ...
      const DefaultIngredient.header('Finish'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Marinade'),
  ...
  DefaultRecipeData(
    ...
    ingredients: [
      const DefaultIngredient.header('Filling'),
      ...
      const DefaultIngredient.header('Chive Oil'),
