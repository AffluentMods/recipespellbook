...
class RpgAvatars {
  static const List<CosmeticItem> all = [
    ...
    CosmeticItem(
      ...
      assetPath: 'assets/rpg/avatars/apprentice.png',
    ),
    ...
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.common,
      assetPath: 'assets/rpg/avatars/sous_chef.png',
      currency: CurrencyType.gold,
      price: 150,
    ),
    CosmeticItem(
      ...
      assetPath: 'assets/rpg/avatars/baker.png',
      currency: CurrencyType.gold,
      price: 300,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.uncommon,
      assetPath: 'assets/rpg/avatars/sushi_chef.png',
      currency: CurrencyType.gold,
      price: 400,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.uncommon,
      assetPath: 'assets/rpg/avatars/grill_master.png',
      currency: CurrencyType.gold,
      price: 400,
    ),
    CosmeticItem(
      ...
      assetPath: 'assets/rpg/avatars/pastry_chef.png',
      currency: CurrencyType.gold,
      price: 750,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.rare,
      assetPath: 'assets/rpg/avatars/wizard_chef.png',
      currency: CurrencyType.gold,
      price: 1000,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.rare,
      assetPath: 'assets/rpg/avatars/knight_chef.png',
      currency: CurrencyType.gold,
      price: 1000,
    ),
    CosmeticItem(
      ...
      assetPath: 'assets/rpg/avatars/royal_chef.png',
      currency: CurrencyType.gold,
      price: 2500,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.epic,
      assetPath: 'assets/rpg/avatars/dragon_chef.png',
      currency: CurrencyType.gold,
      price: 3000,
    ),
    ...
    CosmeticItem(
      ...
      assetPath: 'assets/rpg/avatars/master_chef.png',
    ...
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.legendary,
      assetPath: 'assets/rpg/avatars/celebrity_chef.png',
    ...
    CosmeticItem(
      ...
      type: CosmeticType.avatar,
      rarity: CosmeticRarity.epic,
      assetPath: 'assets/rpg/avatars/premium_chef.png',
...
class RpgFrames {
  static const List<CosmeticItem> all = [
    ...
    CosmeticItem(
      ...
      rarity: CosmeticRarity.common,
      assetPath: 'assets/rpg/frames/default.png',
    ),
    ...
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.common,
      assetPath: 'assets/rpg/frames/wooden.png',
      currency: CurrencyType.gold,
      price: 75,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.common,
      assetPath: 'assets/rpg/frames/copper.png',
      currency: CurrencyType.gold,
      price: 100,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.uncommon,
      assetPath: 'assets/rpg/frames/silver.png',
      currency: CurrencyType.gold,
      price: 250,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.rare,
      assetPath: 'assets/rpg/frames/golden.png',
      currency: CurrencyType.gold,
      price: 750,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.epic,
      assetPath: 'assets/rpg/frames/enchanted.png',
      currency: CurrencyType.gold,
      price: 2000,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.rare,
      assetPath: 'assets/rpg/frames/flames.png',
      currency: CurrencyType.gold,
      price: 1000,
    ),
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.rare,
      assetPath: 'assets/rpg/frames/ice.png',
      currency: CurrencyType.gold,
      price: 1000,
    ),
    ...
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.legendary,
      assetPath: 'assets/rpg/frames/legendary.png',
    ...
    CosmeticItem(
      ...
      type: CosmeticType.frame,
      rarity: CosmeticRarity.epic,
      assetPath: 'assets/rpg/frames/streak.png',
